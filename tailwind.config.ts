  ...
  theme: {
    ...
    colors: {
      ...
      blue: {
        ...
        dark: "var(--color-primary-dark, #1C3FB7)",
        light: "var(--color-primary-light, #5475E5)",
        "light-2": "var(--color-primary-light-2, #8099EC)",
        "light-3": "var(--color-primary-light-3, #ADBCF2)",
        "light-4": "var(--color-primary-light-4, #C3CEF6)",
        "light-5": "var(--color-primary-light-5, #E1E8FF)",
      },
      red: {
        DEFAULT: "#F23030",
        dark: "#E10E0E",
